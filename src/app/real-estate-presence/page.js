...
import RealEstatePresence from '@/components/pages/RealEstatePresence'
    ...
    <div>
                ...
                <div className="relative w-full h-[250px] overflow-hidden mb-1">
                    ...
                    <div className="absolute inset-0 flex flex-col justify-center items-center text-white w-full px-4 lg:px-0">
                        <h1 className="text-5xl lg:text-5xl font-bold pt-10 text-center font-playfair pb-3 z-20">Real Estate Presence</h1>
                    </div>
                </div>

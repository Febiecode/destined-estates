            ...
            <div className="text-gray-800">
                ...
                >
                    ...
                    <div className="bg-white bg-opacity-75 py-10 px-5 mx-4 md:w-2/3 rounded-lg text-left my-10 font-opensans">
                        ...
                        <p className="text-lg md:text-xl lg:text-2xl xl:text-3xl !leading-relaxed text-left">
                ...
                {/* 3rd Section */}
                <Parallax
                    bgImage="static/WhoWeAre/operations-intelligence.jpeg"
                    strength={300}
                ...
                {/* 4th Section */}
                <Parallax
                    bgImage="static/WhoWeAre/insights.jpeg"
                    strength={300}

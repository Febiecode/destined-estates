            ...
            <div className="text-gray-800">
                ...
                >
                    ...
                    <div className="bg-white bg-opacity-75 py-10 px-5 mx-4 md:w-2/3 rounded-lg text-left my-10 font-opensans">
                        <h1 className="text-purple-950 text-3xl font-bold mb-4">
                            Destined Estates
                        </h1>
                        <p className="text-md lg:text-lg text-left !leading-relaxed">
                ...
                >
                    <div className='flex justify-start items-center'>
                        <div className="bg-white bg-opacity-75 py-10 px-5 mx-4 md:w-2/3 rounded-lg text-left my-10 font-opensans">
                            <h2 className="text-purple-950 text-3xl font-bold mb-4">
                                Leveraging the Destined Estates Property Ecosystem
                            </h2>
                            <p className="text-md lg:text-lg !leading-relaxed text-left">

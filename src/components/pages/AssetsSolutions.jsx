...
import buyingSelling from '../../../public/buyingSelling.json';
        ...
        <div className="min-h-screen bg-gray-100 p-6">
            ...
            <div className='mb-10 bg-white p-6 rounded-lg shadow-lg flex flex-col lg:flex-row items-center'>
                ...
                <div className='lg:w-3/5 '>
                    <h2 className="text-purple-950 text-2xl md:text-3xl lg:text-3xl xl:text-4xl font-bold mb-4 text-left">Let us get you the Destined service that you desire.</h2>
                    <p className="text-xl md:text-2xl lg:text-2xl xl:text-3xl !leading-relaxed">
            ...
            <div className='mb-10 bg-white p-6 rounded-lg shadow-lg flex flex-col-reverse lg:flex-row items-center'>
                ...
                <div className='lg:w-3/5 '>
                    <h2 className="text-purple-950 text-2xl md:text-3xl lg:text-3xl xl:text-4xl font-bold mb-4  text-left">Buying and selling of Assests</h2>
                    <p className="text-xl md:text-2xl lg:text-2xl xl:text-3xl !leading-relaxed">
            ...
            <div className='mb-10 bg-white p-6 rounded-lg shadow-lg flex flex-col lg:flex-row items-center'>
                ...
                <div className='lg:w-3/5'>
                    <h2 className="text-purple-950 text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold mb-4  text-left">Navigating Complex challenges and increasing sales bandwidth</h2>
                    <p className="text-xl md:text-2xl lg:text-2xl xl:text-3xl !leading-relaxed">

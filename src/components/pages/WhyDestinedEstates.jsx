            ...
            <div className="w-full h-full overflow-hidden">
                    ...
                    <div className="container mx-auto px-4 flex flex-col-reverse lg:flex-row items-center">
                        ...
                        <div className="md:w-full lg:w-1/2 p-5 overflow-hidden">
                            <ScrollParallax speed={-10}>
                                <Parallax bgImage="/static/Assets/home4.jpg" strength={200} bgImageStyle={{ objectFit: "cover", width: "100%", height: "130%" }}>
                ...
                <section className="relative py-16 bg-gray-200">
                    <div className="container mx-auto px-4 flex flex-col-reverse lg:flex-row-reverse items-center">
                        ...
                        <div className="md:w-full lg:w-1/2 p-5 overflow-hidden">
                            <ScrollParallax speed={-10}>
                                <Parallax bgImage="/static/Assets/professionals.jpg" strength={200} bgImageStyle={{ objectFit: "cover", width: "100%", height: "130%" }}>
                                    <div className="h-64 w-96 md:h-96">
                                        <div className="flex items-center justify-center h-full">
                ...
                <section className="relative py-16 bg-gray-100">
                    <div className="container mx-auto px-4 flex flex-col-reverse lg:flex-row items-center">
                        ...
                        <div className="md:w-full lg:w-1/2 p-5 overflow-hidden">
                            <ScrollParallax speed={-10}>
                                <Parallax bgImage="/static/Assets/promise.jpg" strength={200} bgImageStyle={{ objectFit: "cover", width: "100%", height: "130%" }}>
                                    <div className="h-64 w-96 md:h-96">
                                        <div className="flex items-center justify-center h-full">
